...
const features = [
  ...
  },
  {
    ...
    description: "Instant access to all recipes, costing sheets, and marketing materials in one central hub.",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Grow your own network with unique referral links and track your team's performance automatically.",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
