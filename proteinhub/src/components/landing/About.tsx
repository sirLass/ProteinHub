      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <div className="inline-flex items-center rounded-full border border-zinc-200 bg-white/50 px-3 py-1 text-xs font-bold uppercase tracking-widest text-zinc-500 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/50 mb-8">
               Our Story
            </div>
            <h2 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl dark:text-white leading-tight">
              ...
              <span className="text-zinc-400">Entrepreneurs Since 2024</span>
            </h2>
            <p className="mt-8 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
              Protein Hub PH was founded with a single mission: to provide a high-performance blueprint for aspiring business owners. We believe that true success comes from independence, which is why we don't just supply products—we provide the systems and mentorship to help you build your own brand.
            </p>
            <p className="mt-6 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
              Our founder, a veteran in the fitness distribution industry, personally trains every partner to ensure they have the strategic tools needed to scale their network and dominate their local market.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 border-t border-zinc-100 pt-12 dark:border-zinc-800">
               <div>
                  ...
                  <p className="text-sm text-zinc-500 uppercase tracking-widest mt-1">Active Partners</p>
               </div>
               <div>
                  <p className="text-3xl font-bold text-zinc-900 dark:text-white">100%</p>
                  <p className="text-sm text-zinc-500 uppercase tracking-widest mt-1">Independent Ownership</p>
               </div>
            </div>
          </div>
             ...
             <div className="relative aspect-[4/5] w-full rounded-[32px] border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-12 text-center">
                   <div className="space-y-4">
                      ...
                      <p className="text-sm text-zinc-500">The Blueprint for Your Independent Success</p>
                   </div>
                </div>
             </div>
          </div>
